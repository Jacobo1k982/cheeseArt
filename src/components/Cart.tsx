...
interface CartProps {
    ...
    onClearCart: () => void; // <--- NUEVA PROP AÑADIDA
}
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                                ...
                                <div className="grid grid-cols-2 gap-3 mb-4">
                                    <button
                                        ...
                                        className={`flex items-center justify-center gap-2 p-3 rounded-lg border transition-all text-sm ${deliveryMethod === 'pickup'
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center justify-center gap-2 p-3 rounded-lg border transition-all text-sm ${deliveryMethod === 'delivery'
                                                ? 'bg-amber/10 border-amber text-amber font-semibold'
                                                : 'bg-gray-50 border-gray-200 text-gray-600 hover:bg-gray-100'
                                            }`}
                                    >
